...
const (
	EDITF_ENABLEREQUESTEXTENSIONS  uint32 = 0x00000001
	EDITF_REQUESTEXTENSIONLIST     uint32 = 0x00000002
	EDITF_DISABLEEXTENSIONLIST     uint32 = 0x00000004
	EDITF_ADDOLDKEYUSAGE           uint32 = 0x00000008
	EDITF_ADDOLDCERTTYPE           uint32 = 0x00000010
	EDITF_ATTRIBUTEENDDATE         uint32 = 0x00000020
	EDITF_BASICCONSTRAINTSCRITICAL uint32 = 0x00000040
	EDITF_BASICCONSTRAINTSCA       uint32 = 0x00000080
	EDITF_ENABLEAKIKEYID           uint32 = 0x00000100
	EDITF_ATTRIBUTECA              uint32 = 0x00000200
	EDITF_IGNOREREQUESTERGROUP     uint32 = 0x00000400
	EDITF_ENABLEOCSPREVNOCHECK     uint32 = 0x00000800
	EDITF_ENABLEDEFAULTSMIME       uint32 = 0x00010000
	EDITF_ATTRIBUTESUBJECTALTNAME2 uint32 = 0x00040000
	EDITF_ENABLELDAPREFERRALS      uint32 = 0x00080000
	EDITF_ENABLECHASECLIENTDC      uint32 = 0x00100000
	EDITF_AUDITCERTTEMPLATELOAD    uint32 = 0x00200000
)

// EditFlagNames maps EDITF_ flags to human-readable names.
var EditFlagNames = map[uint32]string{
	EDITF_ENABLEREQUESTEXTENSIONS:  "ENABLEREQUESTEXTENSIONS",
	EDITF_REQUESTEXTENSIONLIST:     "REQUESTEXTENSIONLIST",
	EDITF_DISABLEEXTENSIONLIST:     "DISABLEEXTENSIONLIST",
	EDITF_ADDOLDKEYUSAGE:           "ADDOLDKEYUSAGE",
	EDITF_ADDOLDCERTTYPE:           "ADDOLDCERTTYPE",
	EDITF_ATTRIBUTEENDDATE:         "ATTRIBUTEENDDATE",
	EDITF_BASICCONSTRAINTSCRITICAL: "BASICCONSTRAINTSCRITICAL",
	EDITF_BASICCONSTRAINTSCA:       "BASICCONSTRAINTSCA",
	EDITF_ENABLEAKIKEYID:           "ENABLEAKIKEYID",
	EDITF_ATTRIBUTECA:              "ATTRIBUTECA",
	EDITF_IGNOREREQUESTERGROUP:     "IGNOREREQUESTERGROUP",
	EDITF_ENABLEOCSPREVNOCHECK:     "ENABLEOCSPREVNOCHECK",
	EDITF_ENABLEDEFAULTSMIME:       "ENABLEDEFAULTSMIME",
	EDITF_ATTRIBUTESUBJECTALTNAME2: "ATTRIBUTESUBJECTALTNAME2",
	EDITF_ENABLELDAPREFERRALS:      "ENABLELDAPREFERRALS",
	EDITF_ENABLECHASECLIENTDC:      "ENABLECHASECLIENTDC",
	EDITF_AUDITCERTTEMPLATELOAD:    "AUDITCERTTEMPLATELOAD",
}

// CA Type constants (from ICertAdmin2::GetConfigEntry "CAType")
// Reference: MS-WCCE 3.2.1.4.3.2.12
const (
	CA_TYPE_ENTERPRISE_ROOT_CA uint32 = 0
	CA_TYPE_ENTERPRISE_SUB_CA  uint32 = 1
	CA_TYPE_STANDALONE_ROOT_CA uint32 = 3
	CA_TYPE_STANDALONE_SUB_CA  uint32 = 4
)

// CATypeNames maps CA type values to human-readable names.
var CATypeNames = map[uint32]string{
	CA_TYPE_ENTERPRISE_ROOT_CA: "Enterprise Root CA",
	CA_TYPE_ENTERPRISE_SUB_CA:  "Enterprise Subordinate CA",
	CA_TYPE_STANDALONE_ROOT_CA: "Standalone Root CA",
	CA_TYPE_STANDALONE_SUB_CA:  "Standalone Subordinate CA",
}

// Request disposition values (from Policy\RequestDisposition)
const (
	REQUEST_DISPOSITION_PENDING uint32 = 0
	REQUEST_DISPOSITION_ISSUE   uint32 = 1
)

// RequestDispositionNames maps request disposition values to human-readable names.
var RequestDispositionNames = map[uint32]string{
	REQUEST_DISPOSITION_PENDING: "Pending (Manager Approval Required)",
	REQUEST_DISPOSITION_ISSUE:   "Issue (Auto-approve)",
}
